<?php
 	...
 	* Description: One click import Demo Content - Archi | Interior Design WordPress Theme
 	* Version: 2.6.8
 	* Author: OceanThemes
...
class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
     ...
     * @var object
     */
    public $theme_option_name = 'archi_option'; //set theme options name here - Davis change
	...
	public function set_demo_home(){		
		$page = get_page_by_title( 'Homepage Slider' ); // Edit home page name you want to set here. - Davis change
		if ( isset( $page->ID ) ) {
