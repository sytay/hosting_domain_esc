    ...
    public function demo_installer() {
        ...
        <form method="post">
            ...
            <select name="ot_demo_file" style="width: 100px;">
              ...
              <option value="archidark">Archi Version Dark</option> <!-- Davis change -->
              <option value="archilight">Archi Version Light</option> <!-- Davis change --> 
			  <option value="sidedark">Archi Side Navigation Dark</option> <!-- Davis change --> 
			  <option value="sidelight">Archi Side Navigation Light</option> <!-- Davis change --> 	
            </select>
            <br/><br/>
