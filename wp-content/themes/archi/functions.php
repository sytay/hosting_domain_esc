...
function archi_header_class() {
    ...
    if($archi_option['topbar-onepage']!=false){ 
    ...
    if ($archi_option['mobile-sticky']!=false) {
...
function archi_breadcrumbs() {
    $text['home']     = __('<span class="fa fa-home" style="color:#faab3f;"></span>Trang chủ', 'archi'); // text for the 'Home' link
...
if(function_exists('vc_add_param')){
    ...
    vc_add_param('vc_column',array(
          "type" => "textfield",
          "heading" => esc_html__('Animate delay number.', 'archi'),
          "param_name" => "delay",
          "value" => "",
    ...
    vc_add_param('vc_column',array(
          "type" => "textfield",
          "heading" => esc_html__('Animate duration number.', 'archi'),
          "param_name" => "duration",
          "value" => "",
          "description" => esc_html__("Example : 0.2, 0.6, 1, etc", 'archi'),   
          "dependency"  => array( 'element' => 'animate', 'value' => array( 'fadeinup', 'fadeindown', 'fadein', 'fadeinleft', 'fadinright' ) ),   
...
function archi_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(            
            ...
            'source'             => 'http://oceanthemes.net/plugins-required/archi/js_composer.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
        array(
            'name'               => 'Revolution Slider', // The plugin name.
            'slug'               => 'revslider', // The plugin slug (typically the folder name).            
            'source'             => 'http://oceanthemes.net/plugins-required/archi/revslider.zip', // The plugin source.            
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
        ), 			
		array(            
        ...
        array(            
            ...
            'source'             => 'http://oceanthemes.net/plugins-required/archi/ot_slider_text.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
        ), 
        array(            
