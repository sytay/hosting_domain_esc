...
/* 01 MAIN STYLES
	****************************************************************************************************/
	...
	#mainmenu li.current-menu-item > a, nav ul#mainmenu > li.current-menu-ancestor > a, .mainmenu li.current-menu-item > a, nav ul.mainmenu > li.current-menu-ancestor > a {color: <?php echo esc_attr( $archi_option['main-color'] ); ?>;opacity:1;}
